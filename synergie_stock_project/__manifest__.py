...
source projet sur transfert (_get_picking_project).
    ...
    # Detail") : ce widget construit son domaine de recherche de quants en
    # JavaScript (onAdd()), indépendamment de tout attribut `domain` XML — le
    # domaine posé sur le champ quant_id (stock_move_line_views.xml) ne s'y
    # applique pas. Cf. README §5.3.
    "assets": {
        "web.assets_backend": [
