...
class StockQuant(models.Model):
    ...
    def _get_gather_domain(self, product_id, location_id, lot_id=None, package_id=None, owner_id=None, strict=False):
        ...
        _get_gather_domain() est la fonction où le core Odoo construit le domaine de
        ...
        une clé de contexte ('with_expiration'). Pour étendre ce domaine on suit la même logique 
        avec 'restrict_project_id', posé par stock.move._update_reserved_quantity() (cf. stock_move.py) 
        quand le mouvement porte un projet.
